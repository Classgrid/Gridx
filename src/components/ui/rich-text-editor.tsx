...
interface RichTextEditorProps {
  ...
  onImageUpload?: (file: File) => Promise<{ cdnUrl: string; key: string } | null>;
}
    ...
    const onImageSelected = useCallback(
      async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file.size > 5 * 1024 * 1024) {
          ...
          (e.target as HTMLSelectElement | HTMLInputElement).value = "";
          return;
        }
        ...
        if (onImageUpload) {
          ...
          // Dummy fallback if no prop provided
          result = { cdnUrl: URL.createObjectURL(file), key: file.name };
        }
            ...
            <div className="relative">
              <Select
                ...
                onValueChange={(val) => {
                  ...
                  document.execCommand("formatBlock", false, val as string);
                  syncContent();
                }}
              >
              ...
              <select
                onChange={(e) => {
                  editorRef.current?.focus();
                  document.execCommand("formatBlock", false, (e.target as HTMLSelectElement | HTMLInputElement).value);
                  syncContent();
                  (e.target as HTMLSelectElement | HTMLInputElement).value = "";
                }}
            ...
            <div className="relative">
              <Select
                ...
                onValueChange={(val) => {
                  ...
                  document.execCommand("fontSize", false, val as string);
                  syncContent();
                }}
              >
              ...
              <select
                onChange={(e) => {
                  editorRef.current?.focus();
                  document.execCommand("fontSize", false, (e.target as HTMLSelectElement | HTMLInputElement).value);
                  syncContent();
                  (e.target as HTMLSelectElement | HTMLInputElement).value = "";
                }}
                onClick={(e) => e.stopPropagation()}
